    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        getInfoTemplate: function (layer, layerId, result) {
            ...
            if (!popup) {
				...
				console.log(popup);
				console.log("No popup config defined");
            }
        ...
        createInfoTemplate: function (layer, layerId, result) {
            var popup = null, fieldInfos = [],fieldInfosNew = [];
            ...
            if (result) {
                layerName = result.layerName;
					  ...
					  fieldInfosNew = [{
						fieldName: "Primary Cause of Damage",
						visible: true
					  }, {
						fieldName: "Extent of Damage",
						visible: true
					  }];
            }
