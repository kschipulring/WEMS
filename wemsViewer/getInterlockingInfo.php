...
//Interlocking ID
$itlId = isset($_GET['param']) ? $_GET['param'] : -1;

//if it is a potentially valid Interlocking ID
if($itlId >= 0){
	$qry = oci_parse($c, "SELECT CTID, FULLNAME FROM WEMS_CLEANABLE_TARGET where MARKERID = :MARKERID and TYPE = 'I'")
