...
if(isset($_POST['login']))
{
  ...
  else
  {
    ...
    ldapauthenticate($username, $password);
  }
}
 //-------------------------------------------------
          ...
          if (@ldap_bind($ldap, "$dn", "$password"))
            {
				...
				//	}
					//else
					//{
					//	header("Location: cmcdev.lirr.org");
					//}
...
<title>MTA Long Island Rail Road / Configuration Management   </title>
...
<div  id="bannerMenu" >
 ...
 <center><H1>Configuration Management Central <br> Login</H1></center>
